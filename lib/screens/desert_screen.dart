...
import 'package:food_delivery/models/desert.dart';
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child:  Text(widget.desert.name, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                    ),
...
//                    )
          ...
          Expanded(
              child: GridView.count(
                ...
                children: List.generate(widget.desert.menu.length, (index) {
                  Food food = widget.desert.menu[index];
